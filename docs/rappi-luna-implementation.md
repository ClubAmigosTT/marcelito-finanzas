...
La versión vigente del lector es `ios-reader-recovery-2026.09.25.15`; mantiene el trabajo PDF/Vision serializado, las cancelaciones entre páginas y las compuertas de identidad, conciliación y filas. El contrato compartido sigue en `rappi-shared-engine-2026.09.25.2`. La certificación previa ya no corresponde y no habilita una publicación nueva; hay que repetir el corpus con la versión actual.
...
- Versión del lector que debe aparecer en los próximos informes: `ios-reader-recovery-2026.09.25.15`.
...
- La versión vigente del lector nativo es `ios-reader-recovery-2026.09.25.15` y la del motor es `rappi-shared-engine-2026.09.25.2`. Cualquier cambio de contrato exige actualizar ambas pruebas de bundle y la versión del lector.
