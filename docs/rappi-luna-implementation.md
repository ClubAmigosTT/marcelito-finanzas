...
- Head actual: `4739437b5b7f4e418b1c7474212d90939953bfba` (`docs: record validated Rappi implementation handoff`).
- Tag de entrega: `ios-v1.0.5-bootstrap`, apuntando al head actual.
...
El build 203 es el bootstrap vigente para que Luna ejecute la certificación nativa y la prueba física; ya contiene la normalización de prefijos de procesador, la separación de evidencia y el visor móvil de esta iteración. No debe confundirse con el build 202: ese artefacto es histórico y no contiene la normalización nueva.
