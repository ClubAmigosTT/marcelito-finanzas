...
La versión del lector se actualizó el 23-sep-2026 a `ios-reader-recovery-2026.09.23.2` para serializar el trabajo PDF/Vision y respetar cancelaciones entre páginas. El contrato compartido sigue en `rappi-shared-engine-2026.09.23.1`. La certificación previa ya no corresponde y no habilita una publicación nueva; hay que repetir el corpus con la versión actual.
...
- Versión del lector que debe aparecer en los próximos informes: `ios-reader-recovery-2026.09.23.2`.
...
- La versión vigente del lector nativo es `ios-reader-recovery-2026.09.23.2` y la del motor es `rappi-shared-engine-2026.09.23.1`. Cualquier cambio de contrato exige actualizar ambas pruebas de bundle y la versión del lector.
