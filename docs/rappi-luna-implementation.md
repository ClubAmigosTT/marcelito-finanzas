...
- La versión del lector nativo es `ios-reader-deterministic-2026.09.16.3` y la del motor es `rappi-shared-engine-2026.09.16.2`. Cualquier cambio de contrato exige actualizar ambas pruebas de bundle y la versión del lector.
