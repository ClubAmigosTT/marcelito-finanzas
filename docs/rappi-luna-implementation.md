...
- Versión del lector que debe aparecer en los informes: `ios-reader-recovery-2026.09.17.1`.
...
- La versión del lector nativo es `ios-reader-recovery-2026.09.17.1` y la del motor es `rappi-shared-engine-2026.09.16.2`. Cualquier cambio de contrato exige actualizar ambas pruebas de bundle y la versión del lector.
